...
mesh = Mesh("/element_fini/LEPL1110_elem_fini/groupe048-bdallemagne-tirgel/ProjectPostProcessor/data/mesh.txt")
print(mesh)
uv = np.loadtxt("ProjectPostProcessor/data/UV.txt", skiprows=1, delimiter=",")
...
plt.grid(alpha=0.2)
plt.show()
plt.savefig("ProjectPostProcessor/data/plot.png")
