...
int main(void) {
  ...
  //femElasticityAddBoundaryCondition(theProblem, "Leaning rectangle left", NEUMANN_N, -1e6, NAN);
  femElasticityAddBoundaryCondition(theProblem, "Arc4", NEUMANN_N, -1.5e6, NAN);
