...
//
    ...
    int ierr;
    int idPlate = gmshModelOccAddRectangle(0, 0, 0, w, h, 0,0, &ierr);
    ErrorGmsh(ierr);
    int idNotch = gmshModelOccAddDisk(x0, y0, 0, r0, r0, 0,NULL,0,NULL,0,&ierr); 
    ErrorGmsh(ierr);
    int idHole  = gmshModelOccAddDisk(x1, y1, 0, r1, r1,0,NULL,0,NULL,0,&ierr);  
    ErrorGmsh(ierr);
